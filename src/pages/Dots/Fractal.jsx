...
const Fractal = () => {
    ...
    const sketch = (p) => {
        ...
        const drawDotBetween = (dot1, dot2) => {
            const dot3 = {
                ...
                <FormRow className="xs:grid-cols-3">
                    ...
                    <div className='col-span-2'>
                        <TextInput
                            ...
                            value={vertexNum}
                            min="2"
                            onChange={(e) => setVertexNum(parseInt(e.currentTarget.value))}
                        />
                    </div>
                </FormRow>
                <FormRow className="xs:grid-cols-3">
                    ...
                    <div className='col-span-2'>
                        <TextInput
                            ...
                            value={dotSize}
                            min="1"
                            onChange={(e) => setDotSize(parseInt(e.currentTarget.value))}
                        />
                    </div>
                </FormRow>
                <FormRow className="xs:grid-cols-3">
                ...
                <FormRow className="xs:grid-cols-3">
                    ...
                    <div className='col-span-2'>
                        <TextInput
                            ...
                            value={dotAmount}
                            min="1"
                            onChange={(e) => setDotAmount(parseInt(e.currentTarget.value))}
                        />
                    </div>
                </FormRow>
                <FormRow className="xs:grid-cols-3">
