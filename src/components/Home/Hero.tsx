    ...
    <section id="hero" className="relative">
      <div className="relative px-4 md:px-8 pt-20 md:pt-32 pb-32 md:pb-40">
          <div className="text-center">
              ...
              <p className="text-center mt-8"><a href="https://raw.githubusercontent.com/nnearobot/cv/main/Rimma_Maksiutova_CV.pdf" className="border border-zinc-200 rounded-xl px-4 py-2 text-md text-zinc-200">
